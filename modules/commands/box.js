...
module.exports.run = async ({
    ...
    if (args[0] == "me") {
        if (args[1] == "setqtv") {
            ...
            else if (!global.config.ADMINBOT.includes(event.senderID)) api.sendMessage("Cần quyền ADMIN để thực hiện lệnh", event.threadID, event.messageID)
